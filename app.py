...
# This regex is a common compromise for validating email addresses without being overly strict
# or overly permissive, covering most common valid formats.
...
def register():
    ...
    # TASK-123: Add email format validation
